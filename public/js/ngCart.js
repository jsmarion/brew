...
angular.module('ngCart', ['ngCart.directives', 'credit-cards'])
    ...
    .controller('CartController',['$scope', 'ngCart', function($scope, ngCart) {
        ...
        $scope.sa = ngCart.$cart.sa;
        $scope.ba = ngCart.$cart.ba;
        $scope.card = ngCart.$cart.card;
...
angular.module('ngCart.directives', ['ngCart.fulfilment'])
    ...
    .directive('ngcartIcon', [function(){
        return {
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'template/ngCart/carticon.html';
                } else {
                    return attrs.templateUrl;
                }
            }
    ...
    .directive('ngcartSidebarcart', [function(){
        return {
            restrict : 'E',
            controller : 'CartController',
            scope: {},
            ...
            templateUrl: function(element, attrs) {
                if ( typeof attrs.templateUrl == 'undefined' ) {
                    return 'template/ngCart/sidebarcart.html';
                } else {
                    return attrs.templateUrl;
                }
            }
    ...
    .service('ngCart.fulfilment.http', ['$http', 'ngCart', function($http, ngCart){
        ...
        this.checkout = function(settings){
            return $http.post(settings.url,
                { data: [ ngCart.toObject()/*, $scope.sa.toObject()*/ ], options: settings.options});
        }
    }])
